...
class Mailer:
    ...
    def send_messages(self, subject, context, to_emails):
        messages = self.__generate_messages(subject, context, to_emails)
    ...
    def __generate_messages(self, subject, context, to_emails):
        """
        ...
        for recipient in to_emails:
            message = EmailMessage('test', 'test', to=[recipient], from_email=self.from_email)
